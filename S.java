...
public class S extends Tetromino {
	...
	public S(Game game) {
		...
		Coordinate d = new Coordinate(center - 2, 1);
	...
	public boolean rotate() {
		...
		switch (orientation) {
		case 0:
			newOrigin = getOrigin().translate(-2, -1);
			/*
		...
		case 1:
			newOrigin = getOrigin().translate(0, 2);
			/*
			if (newOrigin.col < 0 || newOrigin.row < 0) {
				rotate = false;
				break;
